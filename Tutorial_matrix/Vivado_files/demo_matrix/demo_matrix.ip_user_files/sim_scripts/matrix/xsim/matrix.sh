...
#
# Script generated by Vivado on Mon Jun 02 21:46:09 +0530 2025
...
#
# Usage        : matrix.sh
#                matrix.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                matrix.sh [-reset_run]
#                matrix.sh [-reset_log]
#                matrix.sh [-help]
#
...
export RDI_DATADIR="C:/Xilinx_2024_ent/Vivado/2024.2/data"
...
# script info
echo -e "matrix.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./matrix.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L zynq_ultra_ps_e_vip_v1_0_19 -L lib_pkg_v1_0_4 -L fifo_generator_v13_2_11 -L lib_fifo_v1_0_20 -L lib_srl_fifo_v1_0_4 -L lib_cdc_v1_0_3 -L axi_datamover_v5_1_35 -L axi_sg_v4_1_19 -L axi_dma_v7_1_34 -L xlconstant_v1_1_9 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L xbip_pipe_v3_0_10 -L xbip_dsp48_wrapper_v3_0_6 -L mult_gen_v12_0_22 -L floating_point_v7_1_19 -L gigantic_mux -L xlconcat_v2_1_6 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot matrix xil_defaultlib.matrix xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim matrix -key {Behavioral:sim_1:Functional:matrix} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fb28.protoinst" -protoinst "protoinst_files/bd_a737.protoinst" -protoinst "protoinst_files/bd_d138.protoinst" -protoinst "protoinst_files/matrix.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Xilinx_2024_ent/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb matrix.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./matrix.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: matrix.sh [-help]\n\
Usage: matrix.sh [-step]\n\
Usage: matrix.sh [-lib_map_path]\n\
Usage: matrix.sh [-reset_run]\n\
Usage: matrix.sh [-reset_log]\n\
Usage: matrix.sh [-keep_index]\n\
Usage: matrix.sh [-noclean_files]\n\n\
