...
-- Date        : Mon Jun  2 21:50:28 2025
-- Host        : Samarth-Asus running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub
--               c:/Users/Samarth/Desktop/IIIT_Intern/Tutorial_matrix/Vivado_files/demo_matrix/demo_matrix.gen/sources_1/bd/matrix/ip/matrix_matrixmul_8_unopt_0_1/matrix_matrixmul_8_unopt_0_1_stub.vhdl
-- Design      : matrix_matrixmul_8_unopt_0_1
...
entity matrix_matrixmul_8_unopt_0_1 is
  Port ( 
    ap_clk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of matrix_matrixmul_8_unopt_0_1 : entity is "matrix_matrixmul_8_unopt_0_1,matrixmul_8_unopt,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of matrix_matrixmul_8_unopt_0_1 : entity is "matrix_matrixmul_8_unopt_0_1,matrixmul_8_unopt,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=matrixmul_8_unopt,x_ipVersion=1.0,x_ipCoreRevision=2114110345,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of matrix_matrixmul_8_unopt_0_1 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of matrix_matrixmul_8_unopt_0_1 : entity is "HLS";
  attribute hls_module : string;
  attribute hls_module of matrix_matrixmul_8_unopt_0_1 : entity is "yes";
end matrix_matrixmul_8_unopt_0_1;

architecture stub of matrix_matrixmul_8_unopt_0_1 is
  ...
  attribute X_INTERFACE_PARAMETER of ap_clk : signal is "XIL_INTERFACENAME ap_clk, ASSOCIATED_BUSIF in_A:out_C, ASSOCIATED_RESET ap_rst_n, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN matrix_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of in_A_TDATA : signal is "XIL_INTERFACENAME in_A, TUSER_WIDTH 0, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 1, HAS_TKEEP 1, HAS_TLAST 1, FREQ_HZ 99999001, PHASE 0.0, CLK_DOMAIN matrix_zynq_ultra_ps_e_0_0_pl_clk0, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of out_C_TDATA : signal is "XIL_INTERFACENAME out_C, TUSER_WIDTH 0, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 1, HAS_TKEEP 1, HAS_TLAST 1, FREQ_HZ 99999001, PHASE 0.0, CLK_DOMAIN matrix_zynq_ultra_ps_e_0_0_pl_clk0, LAYERED_METADATA undef, INSERT_VIP 0";
