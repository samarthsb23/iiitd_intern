...
module matrixmul_32_opt_matrixmul_32_opt_Pipeline_loop_output_C2118 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [31:0] output_C_25_q0;
input  [31:0] empty_46_i;
output  [31:0] empty_46_o;
output   empty_46_o_ap_vld;
input  [3:0] empty_47_i;
output  [3:0] empty_47_o;
output   empty_47_o_ap_vld;
input  [0:0] empty_48_i;
output  [0:0] empty_48_o;
output   empty_48_o_ap_vld;
...
reg ap_idle;
reg[31:0] empty_46_o;
reg empty_46_o_ap_vld;
reg[3:0] empty_47_o;
reg empty_47_o_ap_vld;
reg[0:0] empty_48_o;
reg empty_48_o_ap_vld;
reg out_C_TVALID;
...
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_col_13;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        empty_46_o_ap_vld = 1'b1;
    end else begin
        empty_46_o_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp0) & (1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        empty_47_o_ap_vld = 1'b1;
    end else begin
        empty_47_o_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp0) & (1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        empty_48_o_ap_vld = 1'b1;
    end else begin
        empty_48_o_ap_vld = 1'b0;
    end
end
...
assign add_ln53_fu_138_p2 = (ap_sig_allocacmp_col_13 + 6'd1);
...
assign bitcast_ln69_fu_154_p1 = output_C_25_q0;

assign icmp_ln53_fu_132_p2 = ((ap_sig_allocacmp_col_13 == 6'd32) ? 1'b1 : 1'b0);

assign out_C_TDATA = empty_46_i;

assign out_C_TKEEP = empty_47_i;

assign out_C_TLAST = empty_48_i;

assign out_C_TSTRB = empty;

assign output_C_25_address0 = zext_ln53_fu_144_p1;

assign output_C_25_ce0 = output_C_25_ce0_local;

assign zext_ln53_fu_144_p1 = ap_sig_allocacmp_col_13;

endmodule //matrixmul_32_opt_matrixmul_32_opt_Pipeline_loop_output_C2118
