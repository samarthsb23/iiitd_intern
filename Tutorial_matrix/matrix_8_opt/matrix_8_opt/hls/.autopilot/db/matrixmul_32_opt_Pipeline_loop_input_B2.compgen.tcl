...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_B \
    op interface \
    ports { input_B_address0 { O 5 vector } input_B_ce0 { O 1 bit } input_B_we0 { O 1 bit } input_B_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_199_i { I 32 vector } empty_199_o { O 32 vector } empty_199_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_200 { O 4 vector } empty_200_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_201 { O 4 vector } empty_201_ap_vld { O 1 bit } } \
} "
}
