...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename output_C_24 \
    op interface \
    ports { output_C_24_address0 { O 5 vector } output_C_24_ce0 { O 1 bit } output_C_24_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'output_C_24'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_49_i { I 32 vector } empty_49_o { O 32 vector } empty_49_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_50_i { I 4 vector } empty_50_o { O 4 vector } empty_50_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_51_i { I 1 vector } empty_51_o { O 1 vector } empty_51_o_ap_vld { O 1 bit } } \
} "
}
