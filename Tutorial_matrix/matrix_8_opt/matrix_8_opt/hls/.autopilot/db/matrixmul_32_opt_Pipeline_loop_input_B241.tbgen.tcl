set moduleName matrixmul_32_opt_Pipeline_loop_input_B241
set isTopModule 0
...
set cdfgNum 131
set C_modelName {matrixmul_32_opt_Pipeline_loop_input_B241}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict input_B_10 { MEM_WIDTH 32 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ input_B_10 float 32 regular {array 32 { 0 3 } 0 1 }  }
	...
	{ empty_169 int 32 regular {pointer 2}  }
	{ empty_170 int 4 regular {pointer 1}  }
	{ empty_171 int 4 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "input_B_10", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "empty_169", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "empty_170", "interface" : "wire", "bitwidth" : 4, "direction" : "WRITEONLY"} , 
 	{ "Name" : "empty_171", "interface" : "wire", "bitwidth" : 4, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ input_B_10_address0 sc_out sc_lv 5 signal 0 } 
	{ input_B_10_ce0 sc_out sc_logic 1 signal 0 } 
	{ input_B_10_we0 sc_out sc_logic 1 signal 0 } 
	{ input_B_10_d0 sc_out sc_lv 32 signal 0 } 
	...
	{ empty_169_i sc_in sc_lv 32 signal 5 } 
	{ empty_169_o sc_out sc_lv 32 signal 5 } 
	{ empty_169_o_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ empty_170 sc_out sc_lv 4 signal 6 } 
	{ empty_170_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ empty_171 sc_out sc_lv 4 signal 7 } 
	{ empty_171_ap_vld sc_out sc_logic 1 outvld 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_B_10_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "input_B_10", "role": "we0" }} , 
 	{ "name": "input_B_10_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "input_B_10", "role": "d0" }} , 
 	...
 	{ "name": "empty_169_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "empty_169", "role": "i" }} , 
 	{ "name": "empty_169_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "empty_169", "role": "o" }} , 
 	{ "name": "empty_169_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "empty_169", "role": "o_ap_vld" }} , 
 	{ "name": "empty_170", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "empty_170", "role": "default" }} , 
 	{ "name": "empty_170_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "empty_170", "role": "ap_vld" }} , 
 	{ "name": "empty_171", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "empty_171", "role": "default" }} , 
 	{ "name": "empty_171_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "empty_171", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	input_B_10 { ap_memory {  { input_B_10_address0 mem_address 1 5 }  { input_B_10_ce0 mem_ce 1 1 }  { input_B_10_we0 mem_we 1 1 }  { input_B_10_d0 mem_din 1 32 } } }
	...
	empty_169 { ap_ovld {  { empty_169_i in_data 0 32 }  { empty_169_o out_data 1 32 }  { empty_169_o_ap_vld out_vld 1 1 } } }
	empty_170 { ap_vld {  { empty_170 out_data 1 4 }  { empty_170_ap_vld out_vld 1 1 } } }
	empty_171 { ap_vld {  { empty_171 out_data 1 4 }  { empty_171_ap_vld out_vld 1 1 } } }
