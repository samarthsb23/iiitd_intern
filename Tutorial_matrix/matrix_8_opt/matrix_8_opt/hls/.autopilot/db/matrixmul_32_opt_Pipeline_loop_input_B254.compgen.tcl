...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_B_23 \
    op interface \
    ports { input_B_23_address0 { O 5 vector } input_B_23_ce0 { O 1 bit } input_B_23_we0 { O 1 bit } input_B_23_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_130_i { I 32 vector } empty_130_o { O 32 vector } empty_130_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_131 { O 4 vector } empty_131_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_132 { O 4 vector } empty_132_ap_vld { O 1 bit } } \
} "
}
