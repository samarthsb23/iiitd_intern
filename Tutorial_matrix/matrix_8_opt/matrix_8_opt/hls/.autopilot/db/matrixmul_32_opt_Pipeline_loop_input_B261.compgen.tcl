...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_B_30 \
    op interface \
    ports { input_B_30_address0 { O 5 vector } input_B_30_ce0 { O 1 bit } input_B_30_we0 { O 1 bit } input_B_30_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_109_i { I 32 vector } empty_109_o { O 32 vector } empty_109_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_110 { O 4 vector } empty_110_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_111 { O 4 vector } empty_111_ap_vld { O 1 bit } } \
} "
}
