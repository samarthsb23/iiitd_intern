...
entity matrixmul_32_opt_matrixmul_32_opt_Pipeline_loop_output_C2102 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    output_C_9_q0 : IN STD_LOGIC_VECTOR (31 downto 0);
    empty_94_i : IN STD_LOGIC_VECTOR (31 downto 0);
    empty_94_o : OUT STD_LOGIC_VECTOR (31 downto 0);
    empty_94_o_ap_vld : OUT STD_LOGIC;
    empty_95_i : IN STD_LOGIC_VECTOR (3 downto 0);
    empty_95_o : OUT STD_LOGIC_VECTOR (3 downto 0);
    empty_95_o_ap_vld : OUT STD_LOGIC;
    empty_96_i : IN STD_LOGIC_VECTOR (0 downto 0);
    empty_96_o : OUT STD_LOGIC_VECTOR (0 downto 0);
    empty_96_o_ap_vld : OUT STD_LOGIC;
...
architecture behav of matrixmul_32_opt_matrixmul_32_opt_Pipeline_loop_output_C2102 is 
...
attribute shreg_extract : string;
    ...
    signal ap_sig_allocacmp_col_29 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    add_ln53_fu_138_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_col_29) + unsigned(ap_const_lv6_1));
    ...
    ap_sig_allocacmp_col_29_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, col_fu_68, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_col_29 <= ap_const_lv6_0;
        else 
            ap_sig_allocacmp_col_29 <= col_fu_68;
        end if; 
    end process;

    bitcast_ln69_fu_154_p1 <= output_C_9_q0;

    empty_94_o_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, empty_94_i, bitcast_ln69_fu_154_p1, ap_block_pp0_stage0_01001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_01001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            empty_94_o <= bitcast_ln69_fu_154_p1;
        else 
            empty_94_o <= empty_94_i;
        end if; 
    end process;


    empty_94_o_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            empty_94_o_ap_vld <= ap_const_logic_1;
        else 
            empty_94_o_ap_vld <= ap_const_logic_0;
        end if; 
    end process;


    empty_95_o_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, empty_95_i, ap_block_pp0_stage0_01001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_01001_grp0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            empty_95_o <= ap_const_lv4_F;
        else 
            empty_95_o <= empty_95_i;
        end if; 
    end process;


    empty_95_o_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone_grp0_done_reg, ap_block_pp0_stage0_11001_grp0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            empty_95_o_ap_vld <= ap_const_logic_1;
        else 
            empty_95_o_ap_vld <= ap_const_logic_0;
        end if; 
    end process;


    empty_96_o_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, empty_96_i, ap_block_pp0_stage0_01001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_01001_grp0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            empty_96_o <= ap_const_lv1_0;
        else 
            empty_96_o <= empty_96_i;
        end if; 
    end process;


    empty_96_o_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone_grp0_done_reg, ap_block_pp0_stage0_11001_grp0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            empty_96_o_ap_vld <= ap_const_logic_1;
        else 
            empty_96_o_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    icmp_ln53_fu_132_p2 <= "1" when (ap_sig_allocacmp_col_29 = ap_const_lv6_20) else "0";
    out_C_TDATA <= empty_94_i;
    ...
    out_C_TKEEP <= empty_95_i;
    out_C_TLAST <= empty_96_i;
    out_C_TSTRB <= empty;
    ...
    output_C_9_address0 <= zext_ln53_fu_144_p1(5 - 1 downto 0);
    output_C_9_ce0 <= output_C_9_ce0_local;

    output_C_9_ce0_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
    ...
    zext_ln53_fu_144_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_col_29),64));
end behav;
