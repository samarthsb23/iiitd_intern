...
################################################################
# This is a generated script based on design: matrix
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: matrixmul_unopt_100_1, and set properties
  set matrixmul_unopt_100_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:matrixmul_unopt_100:1.1 matrixmul_unopt_100_1 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins matrixmul_unopt_100_1/in_A]
  ...
  connect_bd_intf_net -intf_net matrixmul_unopt_100_1_out_C [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins matrixmul_unopt_100_1/out_C]
