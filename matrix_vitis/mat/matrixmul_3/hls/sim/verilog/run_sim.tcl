...
if {[file isfile matrixmul_3.autotvin.dat]} {
	file delete -force matrixmul_3.autotvin.dat
}

if {[file isfile matrixmul_3.autotvout.dat]} {
	file delete -force matrixmul_3.autotvout.dat
}
