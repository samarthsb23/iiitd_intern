...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         ...
         "c.find.autotvin_in_vec_V_data_V.dat"
         "c.find.autotvin_in_vec_V_last_V.dat"
         "c.find.autotvin_out_vec_V_data_V.dat"
         "c.find.autotvin_out_vec_V_last_V.dat"
         "c.find.autotvout_out_vec_V_data_V.dat"
         "c.find.autotvout_out_vec_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.find.autotvout_out_vec_V_data_V.dat"
         "rtl.find.autotvout_out_vec_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
