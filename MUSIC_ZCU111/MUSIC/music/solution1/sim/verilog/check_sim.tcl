...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.MUSIC_top.autotvin_in_V_data.dat"
         "c.MUSIC_top.autotvin_in_V_last_V.dat"
         "c.MUSIC_top.autotvin_out_V_data.dat"
         "c.MUSIC_top.autotvin_out_V_last_V.dat"
         "c.MUSIC_top.autotvout_out_V_data.dat"
         "c.MUSIC_top.autotvout_out_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.MUSIC_top.autotvout_out_V_data.dat"
         "rtl.MUSIC_top.autotvout_out_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
