...
if {[file isfile MUSIC_top.autotvin.dat]} {
	file delete -force MUSIC_top.autotvin.dat
}

if {[file isfile MUSIC_top.autotvout.dat]} {
	file delete -force MUSIC_top.autotvout.dat
}
