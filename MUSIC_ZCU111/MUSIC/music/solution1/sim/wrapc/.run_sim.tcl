...
# ==============================================================
set ::env(PATH) "$::env(PATH);C:/Xilinx2/Vivado/2019.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx2/Vivado/2019.1/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);C:/Xilinx2/Vivado/2019.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/Xilinx2/Vivado/2019.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx2/Vivado/2019.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "MUSIC_top.autotvin.dat"
	set constFileTvOut       "MUSIC_top.autotvout.dat"
	set constFileHdlTvIn     "MUSIC_top.autohdltvin.dat"
	set constFileHdlTvOut    "MUSIC_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
