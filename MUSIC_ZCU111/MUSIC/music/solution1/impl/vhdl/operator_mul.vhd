...
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    x_complex_float_re_read : IN STD_LOGIC_VECTOR (31 downto 0);
    x_complex_float_im_read : IN STD_LOGIC_VECTOR (31 downto 0);
    rhs_re_read : IN STD_LOGIC_VECTOR (31 downto 0);
    rhs_im_read : IN STD_LOGIC_VECTOR (31 downto 0);
...
architecture behav of operator_mul is 
    ...
    signal m1_reg_104 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_50_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal m2_reg_109 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_56_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal m3_reg_114 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_62_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal m4_reg_119 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal x_complex_float_re_read_int_reg : STD_LOGIC_VECTOR (31 downto 0);
    signal x_complex_float_im_read_int_reg : STD_LOGIC_VECTOR (31 downto 0);
    signal rhs_re_read_int_reg : STD_LOGIC_VECTOR (31 downto 0);
    signal rhs_im_read_int_reg : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_return_0_int_reg : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_return_1_int_reg : STD_LOGIC_VECTOR (31 downto 0);

    component MUSIC_top_fsub_32kbM IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component MUSIC_top_fadd_32lbW IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component MUSIC_top_fmul_32mb6 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    MUSIC_top_fsub_32kbM_U295 : component MUSIC_top_fsub_32kbM
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    MUSIC_top_fadd_32lbW_U296 : component MUSIC_top_fadd_32lbW
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    MUSIC_top_fmul_32mb6_U297 : component MUSIC_top_fmul_32mb6
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    MUSIC_top_fmul_32mb6_U298 : component MUSIC_top_fmul_32mb6
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    MUSIC_top_fmul_32mb6_U299 : component MUSIC_top_fmul_32mb6
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    MUSIC_top_fmul_32mb6_U300 : component MUSIC_top_fmul_32mb6
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    ap_return_1_assign_proc : process(grp_fu_40_p2, ap_ce_reg, ap_return_1_int_reg)
    begin
        if ((ap_const_logic_0 = ap_ce_reg)) then 
