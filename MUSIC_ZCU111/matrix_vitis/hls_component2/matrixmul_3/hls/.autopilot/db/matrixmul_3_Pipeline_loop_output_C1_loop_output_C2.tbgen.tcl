set moduleName matrixmul_3_Pipeline_loop_output_C1_loop_output_C2
set isTopModule 0
...
set cdfgNum 7
set C_modelName {matrixmul_3_Pipeline_loop_output_C1_loop_output_C2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict output_C { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ output_C int 32 regular {array 64 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ output_C_address0 sc_out sc_lv 6 signal 0 } 
...
set Spec2ImplPortList { 
	output_C { ap_memory {  { output_C_address0 mem_address 1 6 }  { output_C_ce0 mem_ce 1 1 }  { output_C_q0 mem_dout 0 32 } } }
	out_C { axis {  { out_C_TREADY out_acc 0 1 }  { out_C_TDATA out_data 1 64 }  { out_C_TVALID out_vld 1 1 } } }
}
