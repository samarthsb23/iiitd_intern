...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrixmul_3.autotvin.dat"
	set constFileTvOut       "matrixmul_3.autotvout.dat"
	set constFileHdlTvIn     "matrixmul_3.autohdltvin.dat"
	set constFileHdlTvOut    "matrixmul_3.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
