...
module matrixmul_32_opt_matrixmul_32_opt_Pipeline_loop274 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
output  [4:0] output_C_12_address0;
output   output_C_12_ce0;
output   output_C_12_we0;
output  [31:0] output_C_12_d0;
...
reg    output_C_12_we0_local;
reg    output_C_12_ce0_local;
reg    ap_done_reg;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter133 == 1'b1))) begin
        output_C_12_ce0_local = 1'b1;
    end else begin
        output_C_12_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter133 == 1'b1))) begin
        output_C_12_we0_local = 1'b1;
    end else begin
        output_C_12_we0_local = 1'b0;
    end
end
...
assign add_ln39_fu_1056_p2 = (ap_sig_allocacmp_col_69 + 6'd1);
...
assign grp_fu_23328_p_din0 = res_605_reg_1324;
...
assign grp_fu_23332_p_din0 = res_606_reg_1344;
...
assign grp_fu_23336_p_din0 = res_607_reg_1364;
...
assign grp_fu_23340_p_din0 = res_608_reg_1384;
...
assign grp_fu_23344_p_din0 = res_609_reg_1404;
...
assign grp_fu_23348_p_din0 = res_610_reg_1424;
...
assign grp_fu_23352_p_din0 = res_611_reg_1444;
...
assign grp_fu_23356_p_din0 = res_612_reg_1464;
...
assign grp_fu_23360_p_din0 = res_613_reg_1484;
...
assign grp_fu_23364_p_din0 = res_614_reg_1504;
...
assign grp_fu_23368_p_din0 = res_615_reg_1524;
...
assign grp_fu_23372_p_din0 = res_616_reg_1544;
...
assign grp_fu_23376_p_din0 = res_617_reg_1564;
...
assign grp_fu_23380_p_din0 = res_618_reg_1584;
...
assign grp_fu_23384_p_din0 = res_619_reg_1604;
...
assign grp_fu_23388_p_din0 = res_620_reg_1624;
...
assign grp_fu_23392_p_din0 = res_621_reg_1644;
...
assign grp_fu_23396_p_din0 = res_622_reg_1664;
...
assign grp_fu_23400_p_din0 = res_623_reg_1684;
...
assign grp_fu_23404_p_din0 = res_624_reg_1704;
...
assign grp_fu_23408_p_din0 = res_625_reg_1724;
...
assign grp_fu_23412_p_din0 = res_626_reg_1744;
...
assign grp_fu_23416_p_din0 = res_627_reg_1764;
...
assign grp_fu_23420_p_din0 = res_628_reg_1784;
...
assign grp_fu_23424_p_din0 = res_629_reg_1804;
...
assign grp_fu_23428_p_din0 = res_630_reg_1824;
...
assign grp_fu_23432_p_din0 = res_631_reg_1844;
...
assign grp_fu_23436_p_din0 = res_632_reg_1864;
...
assign grp_fu_23440_p_din0 = res_633_reg_1884;
...
assign grp_fu_23444_p_din0 = res_634_reg_1904;
...
assign output_C_12_address0 = zext_ln39_reg_1243_pp0_iter132_reg;

assign output_C_12_ce0 = output_C_12_ce0_local;

assign output_C_12_d0 = res_635_reg_1914;

assign output_C_12_we0 = output_C_12_we0_local;

assign zext_ln39_fu_1062_p1 = ap_sig_allocacmp_col_69;
...
endmodule //matrixmul_32_opt_matrixmul_32_opt_Pipeline_loop274
