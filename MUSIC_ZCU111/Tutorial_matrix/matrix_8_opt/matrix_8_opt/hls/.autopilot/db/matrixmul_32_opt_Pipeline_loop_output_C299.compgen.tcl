...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_C_6 \
    op interface \
    ports { output_C_6_address0 { O 5 vector } output_C_6_ce0 { O 1 bit } output_C_6_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'output_C_6'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_10_i { I 32 vector } empty_10_o { O 32 vector } empty_10_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_11_i { I 4 vector } empty_11_o { O 4 vector } empty_11_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_12_i { I 1 vector } empty_12_o { O 1 vector } empty_12_o_ap_vld { O 1 bit } } \
} "
}
