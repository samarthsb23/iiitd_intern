...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_C_3 \
    op interface \
    ports { output_C_3_address0 { O 5 vector } output_C_3_ce0 { O 1 bit } output_C_3_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'output_C_3'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_19_i { I 32 vector } empty_19_o { O 32 vector } empty_19_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_20_i { I 4 vector } empty_20_o { O 4 vector } empty_20_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_21_i { I 1 vector } empty_21_o { O 1 vector } empty_21_o_ap_vld { O 1 bit } } \
} "
}
