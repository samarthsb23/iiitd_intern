...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_C_7 \
    op interface \
    ports { output_C_7_address0 { O 5 vector } output_C_7_ce0 { O 1 bit } output_C_7_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'output_C_7'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_100_i { I 32 vector } empty_100_o { O 32 vector } empty_100_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_101_i { I 4 vector } empty_101_o { O 4 vector } empty_101_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_102_i { I 1 vector } empty_102_o { O 1 vector } empty_102_o_ap_vld { O 1 bit } } \
} "
}
