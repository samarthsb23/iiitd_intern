set moduleName matrixmul_32_opt_Pipeline_loop_input_B232
set isTopModule 0
...
set cdfgNum 131
set C_modelName {matrixmul_32_opt_Pipeline_loop_input_B232}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict input_B_1 { MEM_WIDTH 32 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ input_B_1 float 32 regular {array 32 { 0 3 } 0 1 }  }
	...
	{ empty_196 int 32 regular {pointer 2}  }
	{ empty_197 int 4 regular {pointer 1}  }
	{ empty_198 int 4 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "input_B_1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "empty_196", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "empty_197", "interface" : "wire", "bitwidth" : 4, "direction" : "WRITEONLY"} , 
 	{ "Name" : "empty_198", "interface" : "wire", "bitwidth" : 4, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ input_B_1_address0 sc_out sc_lv 5 signal 0 } 
	{ input_B_1_ce0 sc_out sc_logic 1 signal 0 } 
	{ input_B_1_we0 sc_out sc_logic 1 signal 0 } 
	{ input_B_1_d0 sc_out sc_lv 32 signal 0 } 
	...
	{ empty_196_i sc_in sc_lv 32 signal 5 } 
	{ empty_196_o sc_out sc_lv 32 signal 5 } 
	{ empty_196_o_ap_vld sc_out sc_logic 1 outvld 5 } 
	{ empty_197 sc_out sc_lv 4 signal 6 } 
	{ empty_197_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ empty_198 sc_out sc_lv 4 signal 7 } 
	{ empty_198_ap_vld sc_out sc_logic 1 outvld 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "empty_196_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "empty_196", "role": "i" }} , 
 	{ "name": "empty_196_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "empty_196", "role": "o" }} , 
 	{ "name": "empty_196_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "empty_196", "role": "o_ap_vld" }} , 
 	{ "name": "empty_197", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "empty_197", "role": "default" }} , 
 	{ "name": "empty_197_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "empty_197", "role": "ap_vld" }} , 
 	{ "name": "empty_198", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "empty_198", "role": "default" }} , 
 	{ "name": "empty_198_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "empty_198", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	input_B_1 { ap_memory {  { input_B_1_address0 mem_address 1 5 }  { input_B_1_ce0 mem_ce 1 1 }  { input_B_1_we0 mem_we 1 1 }  { input_B_1_d0 mem_din 1 32 } } }
	...
	empty_196 { ap_ovld {  { empty_196_i in_data 0 32 }  { empty_196_o out_data 1 32 }  { empty_196_o_ap_vld out_vld 1 1 } } }
	empty_197 { ap_vld {  { empty_197 out_data 1 4 }  { empty_197_ap_vld out_vld 1 1 } } }
	empty_198 { ap_vld {  { empty_198 out_data 1 4 }  { empty_198_ap_vld out_vld 1 1 } } }
