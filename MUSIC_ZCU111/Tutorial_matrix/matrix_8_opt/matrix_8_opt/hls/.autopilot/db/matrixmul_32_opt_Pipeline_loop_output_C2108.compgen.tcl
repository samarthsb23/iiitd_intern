...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename output_C_15 \
    op interface \
    ports { output_C_15_address0 { O 5 vector } output_C_15_ce0 { O 1 bit } output_C_15_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'output_C_15'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_76_i { I 32 vector } empty_76_o { O 32 vector } empty_76_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_77_i { I 4 vector } empty_77_o { O 4 vector } empty_77_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_78_i { I 1 vector } empty_78_o { O 1 vector } empty_78_o_ap_vld { O 1 bit } } \
} "
}
