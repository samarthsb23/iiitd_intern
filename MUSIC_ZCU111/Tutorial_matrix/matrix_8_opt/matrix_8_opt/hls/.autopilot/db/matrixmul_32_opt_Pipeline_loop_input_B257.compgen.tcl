...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_B_26 \
    op interface \
    ports { input_B_26_address0 { O 5 vector } input_B_26_ce0 { O 1 bit } input_B_26_we0 { O 1 bit } input_B_26_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_121_i { I 32 vector } empty_121_o { O 32 vector } empty_121_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_122 { O 4 vector } empty_122_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_123 { O 4 vector } empty_123_ap_vld { O 1 bit } } \
} "
}
