...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_B_12 \
    op interface \
    ports { input_B_12_address0 { O 5 vector } input_B_12_ce0 { O 1 bit } input_B_12_we0 { O 1 bit } input_B_12_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_163_i { I 32 vector } empty_163_o { O 32 vector } empty_163_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_164 { O 4 vector } empty_164_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_165 { O 4 vector } empty_165_ap_vld { O 1 bit } } \
} "
}
