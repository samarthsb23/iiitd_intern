...
set name matrixmul_32_opt_fadd_32ns_32ns_32_4_full_dsp_1
...
set name matrixmul_32_opt_fmul_32ns_32ns_32_3_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matrixmul_32_opt_input_B_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matrixmul_32_opt_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
