set moduleName matrixmul_32_opt_Pipeline_loop_output_C2111
set isTopModule 0
...
set cdfgNum 131
set C_modelName {matrixmul_32_opt_Pipeline_loop_output_C2111}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict output_C_18 { MEM_WIDTH 32 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ output_C_18 float 32 regular {array 32 { 1 3 } 1 1 }  }
	{ empty_67 int 32 regular {pointer 2}  }
	{ empty_68 int 4 regular {pointer 2}  }
	{ empty_69 int 1 regular {pointer 2}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "output_C_18", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "empty_67", "interface" : "wire", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "empty_68", "interface" : "wire", "bitwidth" : 4, "direction" : "READWRITE"} , 
 	{ "Name" : "empty_69", "interface" : "wire", "bitwidth" : 1, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ output_C_18_q0 sc_in sc_lv 32 signal 0 } 
	{ empty_67_i sc_in sc_lv 32 signal 1 } 
	{ empty_67_o sc_out sc_lv 32 signal 1 } 
	{ empty_67_o_ap_vld sc_out sc_logic 1 outvld 1 } 
	{ empty_68_i sc_in sc_lv 4 signal 2 } 
	{ empty_68_o sc_out sc_lv 4 signal 2 } 
	{ empty_68_o_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ empty_69_i sc_in sc_lv 1 signal 3 } 
	{ empty_69_o sc_out sc_lv 1 signal 3 } 
	{ empty_69_o_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_C_18_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "output_C_18", "role": "q0" }} , 
 	{ "name": "empty_67_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "empty_67", "role": "i" }} , 
 	{ "name": "empty_67_o", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "empty_67", "role": "o" }} , 
 	{ "name": "empty_67_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "empty_67", "role": "o_ap_vld" }} , 
 	{ "name": "empty_68_i", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "empty_68", "role": "i" }} , 
 	{ "name": "empty_68_o", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "empty_68", "role": "o" }} , 
 	{ "name": "empty_68_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "empty_68", "role": "o_ap_vld" }} , 
 	{ "name": "empty_69_i", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "empty_69", "role": "i" }} , 
 	{ "name": "empty_69_o", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "empty_69", "role": "o" }} , 
 	{ "name": "empty_69_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "empty_69", "role": "o_ap_vld" }} , 
...
set Spec2ImplPortList { 
	output_C_18 { ap_memory {  { output_C_18_address0 mem_address 1 5 }  { output_C_18_ce0 mem_ce 1 1 }  { output_C_18_q0 mem_dout 0 32 } } }
	empty_67 { ap_ovld {  { empty_67_i in_data 0 32 }  { empty_67_o out_data 1 32 }  { empty_67_o_ap_vld out_vld 1 1 } } }
	empty_68 { ap_ovld {  { empty_68_i in_data 0 4 }  { empty_68_o out_data 1 4 }  { empty_68_o_ap_vld out_vld 1 1 } } }
	empty_69 { ap_ovld {  { empty_69_i in_data 0 1 }  { empty_69_o out_data 1 1 }  { empty_69_o_ap_vld out_vld 1 1 } } }
