...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_B_17 \
    op interface \
    ports { input_B_17_address0 { O 5 vector } input_B_17_ce0 { O 1 bit } input_B_17_we0 { O 1 bit } input_B_17_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_148_i { I 32 vector } empty_148_o { O 32 vector } empty_148_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_149 { O 4 vector } empty_149_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_150 { O 4 vector } empty_150_ap_vld { O 1 bit } } \
} "
}
