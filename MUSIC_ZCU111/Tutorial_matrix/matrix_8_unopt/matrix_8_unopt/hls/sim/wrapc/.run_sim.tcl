...
# 
# ==============================================================
set ::env(PATH) "C:/Xilinx_2024_ent/Vitis/2024.2/win64/tools/fpo_v7_1;$::env(Path)"
set ::env(PATH) "C:/Xilinx_2024_ent/Vitis/2024.2/win64/tools/fft_v9_1;$::env(Path)"
set ::env(PATH) "C:/Xilinx_2024_ent/Vitis/2024.2/win64/tools/fir_v7_0;$::env(Path)"
set ::env(PATH) "C:/Xilinx_2024_ent/Vitis/2024.2/win64/tools/dds_v6_0;$::env(Path)"
set ::env(PATH) "C:/Xilinx_2024_ent/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt/bin;$::env(Path)"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrixmul_100_unopt.autotvin.dat"
	set constFileTvOut       "matrixmul_100_unopt.autotvout.dat"
	set constFileHdlTvIn     "matrixmul_100_unopt.autohdltvin.dat"
	set constFileHdlTvOut    "matrixmul_100_unopt.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
