...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matrixmul_100_unopt.autotvin_in_A_V_data_V.dat"
         "c.matrixmul_100_unopt.autotvin_in_A_V_keep_V.dat"
         "c.matrixmul_100_unopt.autotvin_in_A_V_strb_V.dat"
         "c.matrixmul_100_unopt.autotvin_in_A_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matrixmul_100_unopt.autotvout_out_C_V_data_V.dat"
         "rtl.matrixmul_100_unopt.autotvout_out_C_V_keep_V.dat"
         "rtl.matrixmul_100_unopt.autotvout_out_C_V_strb_V.dat"
         "rtl.matrixmul_100_unopt.autotvout_out_C_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
