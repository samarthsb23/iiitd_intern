...
if {[file isfile matrixmul_100_unopt.autotvin.dat]} {
	file delete -force matrixmul_100_unopt.autotvin.dat
}

if {[file isfile matrixmul_100_unopt.autotvout.dat]} {
	file delete -force matrixmul_100_unopt.autotvout.dat
}
