; ModuleID = 'C:/Users/Samarth/Desktop/IIIT_Intern/Tutorial_matrix/matrix_100_opt/matrix_100_opt/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_matrixmul_100_opt_ir(%"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %in_A, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %out_C) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_matrixmul_100_opt_hw(i32* %in_A_copy.data, i4* %in_A_copy.keep, i4* %in_A_copy.strb, i1* %in_A_copy.last, i32* %out_C_copy.data, i4* %out_C_copy.keep, i4* %out_C_copy.strb, i1* %out_C_copy.last)
...
declare void @apatb_matrixmul_100_opt_hw(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*)
...
declare void @matrixmul_100_opt_hw_stub(%"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* noalias nonnull)

define void @matrixmul_100_opt_hw_stub_wrapper(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*) #5 {
entry:
  ...
  call void @matrixmul_100_opt_hw_stub(%"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* %9, %"class.hls::stream<hls::axis<float, 0, 0, 0, '8', false>, 0>"* %11)
