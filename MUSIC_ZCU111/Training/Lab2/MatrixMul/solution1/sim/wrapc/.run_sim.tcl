...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrixmul_5.autotvin.dat"
	set constFileTvOut       "matrixmul_5.autotvout.dat"
	set constFileHdlTvIn     "matrixmul_5.autohdltvin.dat"
	set constFileHdlTvOut    "matrixmul_5.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
