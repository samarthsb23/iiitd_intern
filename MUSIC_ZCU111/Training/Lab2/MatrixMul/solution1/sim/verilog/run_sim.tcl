...
if {[file isfile matrixmul_5.autotvin.dat]} {
	file delete -force matrixmul_5.autotvin.dat
}

if {[file isfile matrixmul_5.autotvout.dat]} {
	file delete -force matrixmul_5.autotvout.dat
}
