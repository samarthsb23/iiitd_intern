...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "lab_1.autotvin.dat"
	set constFileTvOut       "lab_1.autotvout.dat"
	set constFileHdlTvIn     "lab_1.autohdltvin.dat"
	set constFileHdlTvOut    "lab_1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
