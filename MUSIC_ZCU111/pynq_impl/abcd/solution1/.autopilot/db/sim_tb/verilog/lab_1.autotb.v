...
`define AUTOTB_TVIN_A_V  "./c.lab_1.autotvin_A_V.dat"
`define AUTOTB_TVIN_B_V  "./c.lab_1.autotvin_B_V.dat"
`define AUTOTB_TVIN_C_V  "./c.lab_1.autotvin_C_V.dat"
`define AUTOTB_TVIN_A_V_out_wrapc  "./rtl.lab_1.autotvin_A_V.dat"
`define AUTOTB_TVIN_B_V_out_wrapc  "./rtl.lab_1.autotvin_B_V.dat"
`define AUTOTB_TVIN_C_V_out_wrapc  "./rtl.lab_1.autotvin_C_V.dat"
`define AUTOTB_TVOUT_Y_V  "./c.lab_1.autotvout_Y_V.dat"
`define AUTOTB_TVOUT_Y_V_out_wrapc  "./impl_rtl.lab_1.autotvout_Y_V.dat"
module `AUTOTB_TOP;
