...
proc create_root_design { parentCell } {
  ...
  # Create instance: matrixmul_1_0, and set properties
  set matrixmul_1_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:matrixmul_1:1.1 matrixmul_1_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins matrixmul_1_0/in_A]
  ...
  connect_bd_intf_net -intf_net matrixmul_1_0_out_C [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins matrixmul_1_0/out_C]
