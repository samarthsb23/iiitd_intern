...
$(ObjDir)/test_qrf.cpp_pre.cpp.tb.o : test_qrf.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling test_qrf.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/kernel_qrf_0.cpp_pre.cpp.tb.o : kernel_qrf_0.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling kernel_qrf_0.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
