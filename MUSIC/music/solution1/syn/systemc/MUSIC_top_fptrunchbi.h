...
// ==============================================================
#ifndef __MUSIC_top_fptrunchbi__HH__
#define __MUSIC_top_fptrunchbi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(MUSIC_top_fptrunchbi) {
    ...
    SC_CTOR(MUSIC_top_fptrunchbi):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
