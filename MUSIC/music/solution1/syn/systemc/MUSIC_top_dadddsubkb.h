...
// ==============================================================
#ifndef __MUSIC_top_dadddsubkb__HH__
#define __MUSIC_top_dadddsubkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(MUSIC_top_dadddsubkb) {
    ...
    SC_CTOR(MUSIC_top_dadddsubkb):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
