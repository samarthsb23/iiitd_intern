...
void MUSIC_top_matrix1rcU::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void MUSIC_top_matrix1rcU::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void MUSIC_top_matrix1rcU::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void MUSIC_top_matrix1rcU::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
