...
// ==============================================================
#ifndef __MUSIC_top_fcmp_32qcK__HH__
#define __MUSIC_top_fcmp_32qcK__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(MUSIC_top_fcmp_32qcK) {
    ...
    SC_CTOR(MUSIC_top_fcmp_32qcK):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
